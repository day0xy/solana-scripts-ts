...
// 高级方法：使用 SystemProgram.transfer() 创建转账指令
...
async function main() {
  try {
    ...
    console.log("\n" + "=".repeat(60));
    await transferWithSystemProgram(connection, sender, recipient.publicKey, transferAmount);
    ...
    await transferWithManualInstruction(connection, sender, recipient.publicKey, transferAmount);
